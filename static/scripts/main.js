...
/***/ function(module, exports, __webpack_require__) {
	...
	var assets = document.querySelectorAll('.loading-asset');

	var hideAsset = function hideAsset(i) {
	  assets[i].classList.remove('is-visible');
	};

	var showAsset = function showAsset(i) {
	  assets[i].classList.add('is-visible');
	};
	...
	var increment = function increment(asset, index) {
	  if (index === 0) {
	    showAsset(index);
	    return;
	  }
	  ...
	  if (index === assets.length - 1) {
	    setTimeout(endLoading, 500 * index + 1000);
	  }
	};

	assets.forEach(increment);
